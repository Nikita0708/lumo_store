    ...
    (t = function (t) {
        ...
        var r = {
          ...
          getRegexMask: function () {
            for (var t, a, s, r, n = [], o = 0; o < e.length; o++)
              (t = i.translation[e.charAt(o)])
                ? ((a = t.pattern.toString().replace(/.{1}$|^.{1}/g, '')),
                  (s = t.optional),
                  (t = t.recursive)
                    ? (n.push(e.charAt(o)), (r = { digit: e.charAt(o), pattern: a }))
                    : n.push(s || t ? a + '?' : a))
            ...
            return (
              ...
              r &&
                (n = n
                  .replace(new RegExp('(' + r.digit + '(.*' + r.digit + ')?)'), '($1)?')
            ...
            if (t !== e) {
              ...
              s > o
                ...
                ? r.maskDigitPosMapOld[s] ||
                  ((n = s), (s = s - (p - c) - t), r.maskDigitPosMap[s] && (s = n))
                : s > n && (s = s + (c - p) + l);
            }
            return s;
          },
            ...
            for (; _(); ) {
              ...
              y
                ? (g.match(y.pattern)
                  ...
                  (d += m))
                : (t || o[k](h),
                  g === h ? (a.push(d), (d += m)) : ((n = h), a.push(d + f), f++),
                  (c += m));
            }
            return (
              (t = e.charAt(v)),
      ...
      var e = function () {
          ...
          if (
            ...
            'true' === e.attr('data-mask-selectonfocus') && (r.selectOnFocus = !0),
            s(e, n, r))
          )
      ...
      (t.fn.mask = function (e, r) {
        ...
        (r = {
          ...
          useInput:
            !/Chrome\/[2-4][0-9]|SamsungBrowser/.test(window.navigator.userAgent) && r('input'),
          watchDataMask: !1,
      ...
      (e = {
        ...
        showProducts: function (s) {
          ...
          let m = t('<div>')
            ...
            k = t('<div>').attr({ class: 'smart-basket__product-delete' }).text('Видалити');
            ...
            for (let a in s[n]) {
              ...
              if (
                ...
                'sbSize' === a &&
                  ...
                  (c
                    .children('span')
                    .append(`<span class="smart-basket__product-size"> Розмір: ${s[n][a]}</span>`),
                  d.val(s[n][a])),
          ...
          return (
            ...
            c.click(function () {
              ...
              if (void 0 !== r[n]) {
                let a = t(this).html();
                return (
                  t(this).text('Товар вже у корзині'),
        ...
        commonResult: function (e, s, r) {
          let n = 0,
            ...
            l = t('<div>')
              ...
              .text('Дякуємо за замовлення, чекайте на дзвінок:)')
              .css('display', 'none'),
          ...
          for (let t in e)
            for (let a in e[t])
              'sbQuantity' === a && (n += +e[t][a]), 'sbPriceCommon' === a && (i += +e[t][a]);
          if ((0 == +n ? o.fadeIn() : o.fadeOut(), r))
            ...
            if (!s)
              return (
                d.html(`<span>Усього товарів: </span> ${n}`),
                p.html(
                  `<span>Загальна ціна: </span> <input name="finalPrice" class="smart-basket__total-cost" type="text" value="${i.toFixed(
                    2
            ...
            0 == +n && t('.' + o.attr('class')).css('display', 'block'),
              t('.' + d.attr('class')).html('<span>Усього товарів: </span> '),
              t('.' + d.attr('class')).html(`<span>Усього товарів: </span> ${n}`),
              t('.' + p.attr('class')).html('<span>Загальна ціна: </span> '),
              t('.' + p.attr('class')).html(
                `<span>Загальна ціна: </span> <input name="finalPrice" class="smart-basket__total-cost" type="text" value="${i.toFixed(
                  2
                )} ${a.smartBasketCurrency}">`
        ...
        getSmartBasketMinState: function (s, r) {
          ...
          a.smartBasketMinText &&
            i.prepend(`<span class="smart-basket__min-text">${a.smartBasketMinText}</span> `);
          let o = t('<img>').attr({
          ...
          r
            ? (t('.' + l.attr('class')).html(''), t('.' + l.attr('class')).html(n))
            : (l.html(n), t('.' + a.smartBasketMinArea).append(i.append(o).append(l))),
        ...
        updateBasket: function (t, a, s, r) {
          ...
          for (let o in t) {
            ...
            for (let a in t[o])
              'sbQuantity' === a && (n += t[o][a]), 'sbPriceCommon' === a && (i += +t[o][a]);
          }
        },
        userForm: function () {
          ...
          let c = t('<div>').attr({ class: 'smart-basket__input-wrapper' }),
            p = t('<input>').attr({
              class: 'smart-basket__user-input',
              type: 'text',
              placeholder: 'Введіть обраний Колір',
              name: 'userEmail',
          ...
          if ((c.append(p), a.agreement.isRequired)) {
            ...
            //   s.is(':checked')
            //     ? r.text('Я прийимаю умови пользовательскої згоди')
            //     : r.text('Я не приймаю умови пользовательскої згоди'),
            //   e.click(function () {
            //     s.is(':checked')
            //       ? (r.text('Я не приймаю умови пользовательскої згоди'),
            //         s.val('Я не приймаю умови пользовательскої згоди'),
            //         m.attr({ disabled: 'disabled' }),
            //         d.addClass('smart-basket__input-wrapper_error'))
            //       : (r.text('Я прийимаю умови пользовательскої згоди'),
            //         s.val('Я прийимаю умови пользовательскої згоди'),
            //         m.attr({ disabled: !1 }),
          ...
          r.append(n).append(o).append(c),
            ...
            m.click(function (t) {
              ...
              if (a.nameIsRequired && a.telIsRequired && a.emailIsRequired) {
                ...
                if (
                  '' === i.val() ||
                  !(('' !== l.val() && a.telIsRequired) || ('' !== p.val() && a.emailIsRequired)) ||
                  r(s)
                )
                  return (
                    '' === l.val() &&
            ...
            a.focus(function () {
              ...
              a.blur(function () {
                t(this).parent().removeClass('smart-basket__input-wrapper_focus'),
                  '' === this.value &&
                    t(this).parent().addClass('smart-basket__input-wrapper_error');
              }),
        ...
        alertBlock: function (a) {
          let s = t('<div>').attr({ class: 'smart-basket__alert-wrapper' }),
            ...
            l = t('<button>')
              .attr({ class: 'smart-basket__alert-button smart-basket__alert-button_close' })
              .text('Продовжити покупки'),
            c = t('<button>')
              .attr({ class: 'smart-basket__alert-button smart-basket__alert-button_by' })
              .text('До кошику');
          l.click(function () {
            t(this)
              .parents('.' + s.attr('class'))
